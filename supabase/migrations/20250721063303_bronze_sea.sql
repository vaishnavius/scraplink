/*
  # SCRAP LINK Database Schema Setup
...
DROP POLICY IF EXISTS "Anyone can read available listings" ON scrap_listings;
DROP POLICY IF EXISTS "Sellers can manage own listings" ON scrap_listings;
DROP POLICY IF EXISTS "Users can read requests involving them" ON pickup_requests;
DROP POLICY IF EXISTS "Recyclers can create pickup requests" ON pickup_requests;
DROP POLICY IF EXISTS "Sellers can update request status" ON pickup_requests;
DROP POLICY IF EXISTS "Users can read own transactions" ON transactions;
DROP POLICY IF EXISTS "Users can create transactions they're involved in" ON transactions;
DROP POLICY IF EXISTS "Anyone can read feedback" ON feedback;
DROP POLICY IF EXISTS "Users can create feedback they send" ON feedback;
